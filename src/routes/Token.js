...
const Token = (props) => {
    ...
    useEffect(async () => {
      ...
      const web3ws = new Web3("wss://duncan:Ht8Q87uOm0Wrdd@apis.ankr.com/wss/76c7912f85ea48a29a1ed97ff4888fd5/f7e957dfdbf73fd87d7c7b81c408c705/binance/full/main")
      ...
      const pairaddress = await contractv1.methods.getPair(props.match.params.tokenAddress,"0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c").call()
      const pairaddressv2 = await contractv2.methods.getPair(props.match.params.tokenAddress,"0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c").call()

    
      const pairContract = new web3.eth.Contract(pairContactABI, pairaddress)
      const pairContractv2 = new web3.eth.Contract(pairContactABI, pairaddressv2)
